...
/**
 * Wires vanilla player-lifecycle events to {@link DiscordService}. Logic-free
 * delegation. Registered on the game event bus for BOTH dists (no {@code value}
 * = Dist filter) so it also runs on a dedicated server.
 */
